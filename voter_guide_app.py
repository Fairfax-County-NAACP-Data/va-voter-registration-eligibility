...
pg = st.navigation([st.Page("1_intro.py", title='FAQ')], position='hidden')
pg.run()

st.info('This site was created by Fairfax County NAACP. The information published by this site '
        'was provided by the [Virginia Department of Elections](https://www.elections.virginia.gov/registration/) except for the '+
